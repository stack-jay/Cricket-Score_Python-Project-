...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.cb0.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.lw1.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.lw2.setStyleSheet("background-color: rgb(255, 255, 255);")
    ...
    def calculate(self):
        import sqlite3
        conn = sqlite3.connect('players.db')
        teams=self.cb0.currentText()
        self.lw1.clear()
        sql1="select players, value from teams where name='"+teams+"'"
